...
%description
PixelKit provides a magnified system-wide color picker, configurable magnifier,
multi-code QR and barcode scanner, color history and format editor, and a
screen ruler with bounds and color-edge measurement modes.
...
%changelog
* Fri Aug 07 2026 PixelKit contributors <70746714+Kuucheen@users.noreply.github.com> - 0.4.1-1
- Release PixelKit 0.4.1

* Wed Aug 05 2026 PixelKit contributors <70746714+Kuucheen@users.noreply.github.com> - 0.4.0-1
- Release PixelKit 0.4.0

* Tue Jul 28 2026 PixelKit contributors <70746714+Kuucheen@users.noreply.github.com> - 0.3.0-1
- Release PixelKit 0.3.0

* Sun Jul 19 2026 PixelKit contributors <70746714+Kuucheen@users.noreply.github.com> - 0.2.0-1
- Release PixelKit 0.2.0

* Wed Jul 15 2026 PixelKit contributors <70746714+Kuucheen@users.noreply.github.com> - 0.1.2-1
